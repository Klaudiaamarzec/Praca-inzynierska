...
public interface NotificationRepository extends JpaRepository <Notification, Long> {
    ...
    @Modifying
    @Transactional
    @Query("DELETE FROM Notification n WHERE n.document.id = :documentId OR n.newDocument.id = :documentId")
    void deleteByDocumentId(@Param("documentId") Long documentId);

    @Modifying
    @Transactional
    @Query("DELETE FROM Notification n WHERE n.document.id = :documentId")
    void deleteByOldDocumentId(@Param("documentId") Long documentId);
