...
public class DocumentServiceTest {
    ...
    @Test
    void testFindDocumentByTitleAndDescription() {

        List<Document> documents = documentService.findDocumentsByTitleAndDescription(null, null, "List", null);

        assertThat(documents).hasSize(3);
    }

    @Test
    void testFindDocumentByTitleAndDescription2() {

        List<Document> documents = documentService.findDocumentsByTitleAndDescription(null, "Jenner", null, null);
        assertThat(documents).hasSize(9);
    }

    @Test
    void testFindDocumentByTitleAndDescription3() {

        List<Document> documents = documentService.findDocumentsByTitleAndDescription("Kendall", null, "plakat", null);
    ...
    void testSearchDocument() {
        ...
        List<Document> documents = documentService.searchDocuments(null, null, null, null, null, null, null, null);
    ...
    void testSearchDocument2() {
        ...
        List<Document> documents = documentService.searchDocuments("Kim", "Kardashian", null, null, null, null, null, null);
    ...
    void testSearchDocument3() {
        ...
        List<Document> documents = documentService.searchDocuments("Kim", null, null, null, null, null, null, null);
    ...
    void testSearchDocument4() {
        ...
        List<Document> documents = documentService.searchDocuments(null, "jenner", null, null, null, null, null, null);
    ...
    void testSearchDocument5() {
        ...
        List<Document> documents = documentService.searchDocuments(null, "jenner", null, null, null, null, null, List.of(2L, 8L));
    ...
    void testSearchDocument6() {
        ...
        List<Document> documents = documentService.searchDocuments(null, "jenner", null, null, null, LocalDate.of(1999,1,1), LocalDate.of(2003,12,31), List.of(2L, 8L));
    ...
    void testSearchDocument7() {
        ...
        List<Document> documents = documentService.searchDocuments(null, "jenner", null, null, null, LocalDate.of(2003,1,1), LocalDate.of(2010,12,31), List.of(2L, 8L));
    ...
    void testSearchDocument8() {
        ...
        List<Document> documents = documentService.searchDocuments(null, "jenner", null, null, List.of(5), LocalDate.of(1999,1,1), LocalDate.of(2003,12,31), List.of(2L, 8L));
    ...
    void testSearchDocument9() {
        ...
        List<Document> documents = documentService.searchDocuments(null, "jenner", null, null, List.of(1, 5), LocalDate.of(1999,1,1), LocalDate.of(2003,12,31), List.of(2L, 8L));
    ...
    @Test
    void testSearchDocument10() {

        List<Document> documents = documentService.searchDocuments(null, "jenner", "plakat", null, null, null, null, null);
